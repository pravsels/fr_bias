...
class GeneratePairs:
    ...
    def _generate_matches_pairs(self):
        ...
        for name in os.listdir(self.data_dir):
            ...
            # printing A
            print("The Array is: ", a) #printing the array
...
if __name__ == '__main__':
    data_dir = "C:\\Project\\Software\\Data\\MS-Celeb-1M\\data\\aligned_face_images\\FaceImageCroppedWithAlignment\\"
    pairs_filepath = "C:\\Project\\Software\\Data\\MS-Celeb-1M\\data\\aligned_face_images\\pairs_aligned_face_images.txt"
    img_ext = ".jpg"

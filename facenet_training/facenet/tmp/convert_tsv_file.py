...
parser.add_argument('--file_path', default='e:/Project/Software/Data/MS-Celeb-1M/data/aligned_face_images/FaceImageCroppedWithAlignment.tsv', type=str,
                    help='the path of csv file')
parser.add_argument('--output_dir', default='e:/Project/Software/Data/MS-Celeb-1M/data/aligned_face_images/FaceImageCroppedWithAlignment/', type=str,
...
def unpack(file_name, output_dir):
    ...
    with open(file_name, "r", encoding="utf-8") as f:
        for line in f:
            m_id, image_search_rank, _, _, face_id, _, face_data = read_line(line)
